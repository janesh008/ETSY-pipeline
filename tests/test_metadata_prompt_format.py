...
def test_master_prompt_contains_required_formatting_rules() -> None:
    ...
    prompt_path = (
        ...
        / "etsy_pipeline"
        / "resources"
        / "Deepseek_etsy_listing_generator_prompt.txt"
    )
    ...
    assert (
        "Listing Title Header" in content
        or "Full Generated Etsy Listing Title" in content
    )
    ...
    assert (
        "DO NOT segregate or break down" in content
        or "State the total count of clipart PNGs directly" in content
    )
