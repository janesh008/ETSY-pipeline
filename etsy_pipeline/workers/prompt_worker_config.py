...
GEMINI_2_5_FLASH_INPUT_PRICE_PER_TOKEN: float = (
    GEMINI_2_5_FLASH_INPUT_RATE_PER_M / 1_000_000.0
)
GEMINI_2_5_FLASH_OUTPUT_PRICE_PER_TOKEN: float = (
    GEMINI_2_5_FLASH_OUTPUT_RATE_PER_M / 1_000_000.0
)
